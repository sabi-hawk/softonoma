...
export function getEcommerceTemplate(title: string): IndustryContentTemplate {
  return {
    hero: {
      title: `${title} Solutions for E-commerce & Retail`,
      description:
        "Drive online sales and enhance customer experiences with powerful e-commerce solutions. We build scalable, feature-rich online stores and retail platforms that convert visitors into customers.",
      primaryButtonText: "Get Started",
    },
    overview: {
      title: "E-commerce & Retail Industry Expertise",
      paragraphs: [
        "E-commerce is reshaping the retail landscape, and we help businesses thrive in the digital marketplace. Our e-commerce solutions combine powerful functionality with exceptional user experiences to drive sales and customer loyalty.",
        "From custom e-commerce platforms and marketplace solutions to inventory management systems and omnichannel retail solutions, we create technology that helps retailers compete and succeed in the digital age.",
      ],
      image:
    ...
    subServices: [
      {
        ...
        description:
          "Custom online stores with product catalogs, shopping carts, payment integration, and order management.",
      },
      {
        icon: "📱",
        title: "Mobile Commerce Apps",
        description:
          "Native and cross-platform mobile shopping apps for iOS and Android with seamless checkout experiences.",
      },
      {
        icon: "🏪",
        title: "Marketplace Solutions",
        description:
          "Multi-vendor marketplace platforms connecting buyers and sellers with commission management and vendor dashboards.",
      },
      {
        icon: "📦",
        title: "Inventory Management",
        description:
          "Real-time inventory tracking, stock management, and automated reordering systems for retail operations.",
      },
      {
        icon: "🔄",
        title: "Omnichannel Retail",
        description:
          "Unified commerce solutions integrating online, mobile, and physical store experiences for seamless customer journeys.",
      },
      {
        icon: "📊",
        title: "E-commerce Analytics",
        description:
          "Advanced analytics and reporting for sales performance, customer behavior, and marketing campaign effectiveness.",
      },
    ],
    technologies: [
      {
    ...
    cards: [
      {
        quote:
          "Our e-commerce platform has transformed our online business. Sales increased by 400% in the first year, and the platform handles peak traffic flawlessly. The user experience is exceptional, and our customers love shopping on our site.",
        author: "Jennifer Lee",
      ...
      {
        quote:
          "They built a multi-vendor marketplace that connects thousands of sellers with buyers. The platform is robust, scalable, and has generated millions in GMV. Their expertise in e-commerce is outstanding!",
        author: "Robert Kim",
        role: "CEO",
      ...
      {
        quote:
          "The mobile commerce app they developed has become our primary sales channel. It's fast, intuitive, and has significantly improved our customer engagement. Mobile sales now account for 60% of our revenue.",
