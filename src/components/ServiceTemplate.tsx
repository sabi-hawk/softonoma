...
import type { ServiceTemplateData } from "@/lib/service-template";
...
import ServiceHeroSection from "./templates/sections/service/ServiceHeroSection";
...
import WhyChooseUsSection from "./templates/sections/service/WhyChooseUsSection";
import TechnologiesSection from "./templates/sections/common/TechnologiesSection";
import ProcessSection from "./templates/sections/service/ProcessSection";
...
import FAQSection from "./templates/sections/service/FAQSection";
import CTASection from "./templates/sections/service/CTASection";
import { isImageUrl } from "./templates/utils/helpers";
...
export default function ServiceTemplate({ data, serviceTitle }: ServiceTemplateProps) {
  ...
  const sectionsMap: Record<string, () => React.ReactElement | null> = {
    hero: () => (
      <ServiceHeroSection
        title={data.hero.title || serviceTitle}
    ...
    whyChooseUs: () =>
      ...
      data.whyChooseUs.items.length > 0 ? (
        <WhyChooseUsSection
          ...
          image={data.whyChooseUs.image}
          certifications={data.whyChooseUs.certifications}
          backgroundColor={data.whyChooseUs.backgroundColor}
        />
      ) : null,
    technologies: () =>
      data.technologies &&
      ...
      data.technologies.items.length > 0 ? (
        <TechnologiesSection
          ...
          getVisibleItems={getVisibleTechItems}
    ...
    process: () =>
      data.process && data.process.steps && data.process.steps.length > 0 ? (
        <ProcessSection
          ...
          backgroundColor={data.process.backgroundColor}
        />
      ) : null,
    portfolio: () =>
      data.portfolio &&
    ...
    faq: () =>
      data.faq && data.faq.items && data.faq.items.length > 0 ? (
        <FAQSection
          ...
          backgroundColor={data.faq.backgroundColor}
        />
      ) : null,
    cta: () =>
      data.cta ? (
  ...
  return (
    <div className="min-h-screen">
      {sectionOrder
        .filter((key: string) => shouldRenderSection(key))
