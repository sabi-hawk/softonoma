...
function Footer({
  ...
  return (
    <footer 
      ...
      style={{
        background: `linear-gradient(to bottom, var(--color-primary-start), var(--color-black))`,
      }}
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Inner Content Container with White Border */}
        <div 
        ...
        >
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
            {/* Company Info */}
            <div className="sm:col-span-2 lg:col-span-2 xl:col-span-2">
              <div className="mb-3 sm:mb-4">
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(to right, var(--color-primary-end), transparent)",
                  }}
                ></div>
              </div>
              <p className="text-gray-300 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed max-w-md">
                {companyDescription}
              </p>
                ...
                {email && (
                  ...
                  >
                    <div
                      ...
                      style={{ backgroundColor: "var(--color-primary-end-rgba-15)" }}
                    >
                      <svg
                  ...
                  <div className="flex items-center gap-2">
                    {socialLinks.linkedin && (
                      <a
                        ...
                        className="w-11 h-11 rounded-lg flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg border"
                        style={{
                ...
                <ul className="space-y-1.5 sm:space-y-2">
                  {quickLinks.map((link, index) => (
                    <li key={index}>
                      <Link
                        href={link.href}
                        className="text-gray-300 theme-hover-primary-end transition-colors text-xs sm:text-sm lg:text-base group flex items-center gap-2 sm:gap-3"
                      >
                        <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full theme-bg-primary-end opacity-0 group-hover:opacity-100 transition-opacity shrink-0"></div>
            ...
            <div className="sm:col-span-2 lg:col-span-1 xl:col-span-2">
              ...
              >
                <input
                  ...
                  style={{
                    borderColor: "var(--color-border-gray-300)",
                  }}
                  onFocus={(e) => {
                    e.target.style.borderColor = "var(--color-primary-end)";
                    e.target.style.boxShadow =
                      "0 0 0 2px var(--color-primary-end-rgba-20)";
                  }}
                  onBlur={(e) => {
                    e.target.style.borderColor = "var(--color-border-gray-300)";
        ...
        {/* Copyright and Legal Links - Below the white border div */}
        <div className="mt-6 sm:mt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 lg:gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 lg:gap-6 text-xs sm:text-sm text-gray-400">
              <Link
                href="/privacy"
                className="theme-hover-primary-end transition-colors"
              >
                Privacy Policy
              </Link>
